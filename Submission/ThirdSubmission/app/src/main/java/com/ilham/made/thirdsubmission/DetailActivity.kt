package com.ilham.made.thirdsubmission
...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (type != null) {
            ...
            if (type.equals(Constants.ACTIVITY_TYPE_MOVIE)) {
            ...
            } else if (type.equals(Constants.ACTIVITY_TYPE_TVSHOW)) {
                ...
                tvShowViewModel.getOneTvShow().observe(this, Observer {
                    ...
                    when (validateLongData(it.runtime!!.size)) {
                        ...
                        1 -> tv_detail_runtime.text =
                            it.runtime!![0].toString() + resources.getString(R.string.minutes)
                        2 -> {
                            var h = 0
