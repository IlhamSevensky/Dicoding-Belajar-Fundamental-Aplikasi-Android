package com.ilham.made.fifthsubmission.ui.search
...
class MovieResultAdapter (private var movies: MutableList<MovieModel>) : RecyclerView.Adapter<MovieResultAdapter.MovieResultViewHolder>() {
    ...
    inner class MovieResultViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(movie: MovieModel) {
            with(itemView) {

                uriWithId =
                    Uri.parse(FavoriteMovieContentProvider.CONTENT_URI.toString() + "/" + movie.movie_id)
                ...
                btn_favorite.setOnClickListener {
                    ...
                    val cursors = context.contentResolver.query(uriWithId, null,null, null, null)
                    ...
                    if (cursors?.count!! > 0){
                        ...
                        context.contentResolver.insert(FavoriteMovieContentProvider.CONTENT_URI, values)
                        Toast.makeText(
                                context,
