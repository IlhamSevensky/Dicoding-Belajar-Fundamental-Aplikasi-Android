...
class TvShowResultAdapter(private var tvshows: MutableList<TvShowModel>) :
    RecyclerView.Adapter<TvShowResultAdapter.TvShowResultViewHolder>() {
    ...
    inner class TvShowResultViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TvShowResultViewHolder {
        return TvShowResultViewHolder(
    ...
    override fun onBindViewHolder(holder: TvShowResultViewHolder, position: Int) =
