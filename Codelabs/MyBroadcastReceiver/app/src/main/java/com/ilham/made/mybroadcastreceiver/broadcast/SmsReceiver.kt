package com.ilham.made.mybroadcastreceiver.broadcast
...
import com.ilham.made.mybroadcastreceiver.SmsReceiverActivity
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        try {
            if (bundle != null) {
                ...
                for (aPdusObje in pdusObj) {
                    val currentMessage = getIncomingMessage(aPdusObje, bundle)
