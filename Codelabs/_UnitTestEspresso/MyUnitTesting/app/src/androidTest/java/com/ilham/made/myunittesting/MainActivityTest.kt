...
class MainActivityTest {
    ...
    // untuk memerintahkan activity mana yang dijalankan
    @get:Rule
    var mActivityRule = ActivityTestRule(MainActivity::class.java)

    @Test
    fun assertGetCircumference(){
        onView(withId(R.id.edt_length)).perform(typeText(dummyLength), closeSoftKeyboard()) // closeSoftKeyboard yang onview/ viewaction
        ...
        onView(withId(R.id.btn_save)).check(matches(isDisplayed())) // pilih matches yang espresso
