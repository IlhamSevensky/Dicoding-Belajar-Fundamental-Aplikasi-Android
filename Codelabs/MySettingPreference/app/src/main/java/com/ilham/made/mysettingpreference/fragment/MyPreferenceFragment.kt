package com.ilham.made.mysettingpreference.fragment
...
import com.ilham.made.mysettingpreference.R
...
class MyPreferenceFragment : PreferenceFragmentCompat(),
    ...
    override fun onResume() {
        super.onResume()
        // register shared preference ketika state onresume
    ...
    override fun onPause() {
        super.onPause()
        // unregister shared preference ketika state onpause
